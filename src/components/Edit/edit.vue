    ...
    <el-container style="height: 100%; " direction="vertical">
      <el-header height="50px">
        <div class="header">
          ...
          <span class="see"><el-button type="info" :icon="View" @click="see">预览</el-button></span>
          <span class="share"><el-button type="info" :icon="Share" @click="share">分享</el-button></span>
        </div>
      </el-header>
      <el-main>
  ...
  <el-dialog v-model="link_share" @close="init_share"
    ...
    <template #header="{ close, titleId, titleClass}">
      <div class="my-header">
        ...
        <el-button style="color: #31a0fb;" @click="copy">
...
function share(){
  ...
  getSharelink(getProject_use().id)
}
